...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'hostel/templates',  # Ensure this points to your 'templates' folder at the root level
        ],
        'APP_DIRS': True,  # This ensures Django will look for templates within app directories as well
        'OPTIONS': {
            'context_processors': [
